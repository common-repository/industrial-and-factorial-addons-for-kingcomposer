...
function industrue_progress_bar_shortcode_init(){
 
    global $kc;
    $kc->add_map(
        array(
            'industrue_progress_bar' => array(
                'name' => 'Progress Bar',
...
function industrue_progress_bar_shortcode($atts, $content = null){
...
add_shortcode('industrue_progress_bar', 'industrue_progress_bar_shortcode');